            ...
            <xsl:for-each select="BlogUsers/BlogUser">
                ...
                <tr>
                    ...
                    <td>
                        ...
                        -->
                        <xsl:value-of select="../../BlogPosts/BlogPost[UserName/text()=$username]/Comments/Comment/CommentId">
                        </xsl:value-of>
                    </td>
                    <td>
                        <xsl:value-of select="../../BlogPosts/BlogPost[UserName/text()=$username]/Comments/Comment/CommentContent">
                        </xsl:value-of>
                    </td>
                </tr>
            </xsl:for-each>
